...
def show_settings(screen):
    ...
    fon = pygame.transform.scale(load_image('theme1.png'), (100, 80))
    screen.blit(fon, (100, 170))

    fon = pygame.transform.scale(load_image('theme2.png'), (100, 80))
    screen.blit(fon, (100, 270))

    fon = pygame.transform.scale(load_image('theme3.png'), (100, 80))
    screen.blit(fon, (100, 370))

    fon = pygame.transform.scale(load_image('accept.png'), (120, 80))
    screen.blit(fon, (550, 500))

    fon = pygame.transform.scale(load_image('back.png'), (120, 80))
    screen.blit(fon, (100, 500))


def show_info(screen):
    screen.fill((0, 0, 0))
    fon = pygame.transform.scale(load_image('developers.png'), (600, 500))
    screen.blit(fon, (0, 0))
    fon = pygame.transform.scale(load_image('history.jpg'), (150, 150))
    screen.blit(fon, (600, 200))
    fon = pygame.transform.scale(load_image('keys.png'), (150, 150))
    screen.blit(fon, (600, 400))
